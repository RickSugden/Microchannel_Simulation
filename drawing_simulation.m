...
%packing density and initial condition pairings were recorded on paper.
close all
clear

NUMBER_OF_TD_FILES = 100;
...
for i = 1:NUMBER_OF_TD_FILES
    ...
    %this loop compares each ball to both walls to check for overlap and if
    %it does then it appends its number in the list to a list of overlapping balls
    for wall_cursor = 0:(2.5*small_r):LY 
...
%This section plots the shear vs packing density 
% subplot(1,2,1);
